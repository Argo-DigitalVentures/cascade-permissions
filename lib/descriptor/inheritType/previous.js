...
export default function Previous(prototype, message = 'no message received', caller = defaultCaller, subject = defaultSubject) {
  ...
  return new Proxy(createPrevious(prototype), LogHandler(message, caller, subject));
}
