...
export default function RestrictedKeys(message = 'no message received', caller = defaultCaller, subject = defaultSubject) {
  return {
    ...
    [_restrictedKeys]: {
      ...
      enumerable: false,
      writable: false,
      value: new Proxy(getRestrictedKeys, LogHandler(message, caller, subject, { verbose: true })),
    },
  };
}
