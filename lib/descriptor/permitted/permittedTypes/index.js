...
export default function PermittedTypes(message = 'no message received', caller = defaultCaller, subject = defaultSubject) {
  return {
    ...
    [_permittedTypes]: {
      ...
      enumerable: false,
      writable: false,
      value: new Proxy(getPermittedTypes, LogHandler(message, caller, subject, { verbose: true })),
    },
  };
}
