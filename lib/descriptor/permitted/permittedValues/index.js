...
export default function PermittedValues(message = 'no message received', caller = defaultCaller, subject = defaultSubject) {
  return {
    ...
    [_permittedValues]: {
      ...
      enumerable: false,
      writable: false,
      value: new Proxy(getPermittedValues, LogHandler(message, caller, subject, { verbose: true })),
    },
  };
}
