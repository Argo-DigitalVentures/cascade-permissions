...
export default function PermittedKeys(message = 'no message received', caller = defaultCaller, subject = defaultSubject) {
  return {
    ...
    [_permittedKeys]: {
      ...
      enumerable: false,
      writable: false,
      value: new Proxy(getPermittedKeys, LogHandler(message, caller, subject, { verbose: true })),
    },
  };
}
