...
export const _restrictedOwnKeysRemove = Symbol.for('RESTRICTED_OWN_KEYS_REMOVE');
export const _restrictedOwnTypesAdd = Symbol.for('RESTRICTED_OWN_TYPES_ADD');
export const _restrictedOwnTypesRemove = Symbol.for('RESTRICTED_OWN_TYPES_REMOVE');
////////////////////////////////////////
// Restricted - end
////////////////////////////////////////
...
export const nativeSymbols = ['inspect', 'util.inspect.custom', Symbol.iterator, Symbol.toStringTag];
