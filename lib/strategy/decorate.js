...
export default function Decorate(message, caller = defaultCaller, subject = defaultSubject, { color = 'green', bold = true } = {}) {
  return function decorateWithDescriptors(prototype, restricted, name) {
    ...
    Object.defineProperties(prototype, Descriptors(message || defaultMessage, caller, subject, { color, bold })(name, restricted));
    return prototype;
  };
}
